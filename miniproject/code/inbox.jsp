...
<div id="img_1">
   <IMG SRC="images\header.png"  ></div>
	...
	<div class="inbox_msgs">
	<%
	String sender=null;
	String text=null;
	String allstudents="All_students@skucet.com";
	
	PreparedStatement ps=con.prepareStatement("SELECT sender,text,receiver FROM messagetable where receiver='"+loginid+"'OR receiver='"+allstudents+"'");
	...
	%>
         ...
         <div class="placing_msgs"><table><tr><td style="font-weight:bold;color:blue">
		 <u>Sender:</u> </td>
		 <td style="font-weight:bold;" ><%out.println(sender);%></td> 
		 </tr>
		 <tr><td colspan="2" style="font-weight:bold;color:blue">
		   <u> Message:</u> </td></tr>
			<tr><td colspan="2" style="font-weight:bold;"><%out.println(text);%>
			</td></tr>
